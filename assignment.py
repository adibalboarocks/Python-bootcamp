...
while True:
    ...
    12)Scorpio
    ''')
    m=int(input("Enter the number corresponding to your Zodiac sign   "))
    ...
    s=input("do you want to continue? If not enter N and if yes enter any other letter other than N")
    if s=="N":
        break
    else:
        continue
